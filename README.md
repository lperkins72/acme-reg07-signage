...
```text
?tenant=acme&region=reg07&device=nuc-001
```

Example:

```text
https://<deployment-domain>/?tenant=acme&region=reg07&device=nuc-001
```
...
5. test one launcher such as `/devices/reg07/nuc-001.html`
